...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Essa história interativa irá contar com o auxilio do usuário na tomada de decisões.");
        System.out.println(
        ...
        if (escolha == 1) {
            ...
            if (escolha_a1 == 1) {
                ...
                System.out.println("O rei, no entando, parece pouco se importar com voce. Apenas dá as costas e vai embora para uma sala com um trono.");
